...
//Flip at enemies
var touchingenemy = collision_rectangle(bbox_left,bbox_top,bbox_right,bbox_bottom,obj_enemy_parent, 0, 1);
...
if (collision_rectangle(bbox_left,bbox_bottom-1,bbox_right,bbox_bottom+2,obj_block_parent,0,1)) {

	//Collision with the bottom of blocks
	var _l = ds_list_create();
	var _blocks = collision_rectangle_list(bbox_left+2,bbox_bottom-1,bbox_right-2,bbox_bottom+2,obj_block_parent,0,1,_l,false);
